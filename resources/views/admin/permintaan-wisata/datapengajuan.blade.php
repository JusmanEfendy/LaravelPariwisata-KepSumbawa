<x-app-layout>
    ...
    @endif
    <x-card>
        <x-slot name="title">List Data Pengajuan Yang Disetujui</x-slot>
        <table class="table table-bordered">
            ...
            <tbody>
                @forelse($dataPengajuanDisetujui as $wis)
                    <tr>
                        <td>{{ $wis->user->name }}</td>
                        <td>{{ $wis->nama }}</td>
    ...
    <x-card>
        <x-slot name="title">List Data Pengajuan Yang Ditolak</x-slot>
        <table class="table table-bordered">
            <thead>
                <th>Diajukan Oleh</th>
                <th>Nama Wisata</th>
            ...
            <tbody>
                @forelse($dataPengajuanDitolak as $wis)
                    <tr>
                        <td>{{ $wis->user->name }}</td>
                        <td>{{ $wis->nama }}</td>
                        <td>{{ $wis->kelurahan->nama }}, {{ $wis->kecamatan->nama }}, {{ $wis->kabupaten->nama }}</td>
